   ...
   $('.custom-pre-sale dt').click(function(){
	...
	<div class="main">
            ...
            <div class="selectNumberScreen">
                ...
                <div id="selectList" class="screenBox screenBackground">
                   ...
                   <dl class="listIndex" id="ComRange" attr="价格范围">
                      <dt><span></span>分公司：</dt>
                     <dd><a href="javascript:void(0)" values="3" attrval="10万以下" type='Com'>北京分公司(<?php echo $total_beijing;?>)</a> 
                      <a href="javascript:void(0)" values="4" attrval="10万-50万" type='Com'>上海分公司(<?php echo $total_shanghai;?>)</a>
                      <a href="javascript:void(0)" values="2" attrval="50万-200万" type='Com'>广州分公司(<?php echo $total_guangzhou;?>)</a>
                      <a href="javascript:void(0)" values="1" attrval="200万-500万" type='Com'>沈阳分公司(<?php echo $total_shenyang;?>)</a>
                      <a href="javascript:void(0)" values="5" attrval="200万-500万" type='Com'>大连分公司(<?php echo $total_dalian;?>)</a>
                    </dl>
                     <dl class="listIndex" id="PriceRange" attr="价格范围">
                      <dt><span></span>合同额：</dt>
                      <dd><a href="javascript:void(0)" values="100000x" attrval="10万以下" type='Price'>10万以下(<?php echo $total_100000x;?>)</a> 
                      <a href="javascript:void(0)" values="100000~500000" attrval="10万-50万" type='Price'>10万-50万(<?php echo $total_100000_500000;?>)</a>
                      <a href="javascript:void(0)" values="500000~2000000" attrval="50万-200万" type='Price'>50万-200万(<?php echo $total_500000_2000000;?>)</a>
                      <a href="javascript:void(0)" values="2000000~5000000" attrval="200万-500万" type='Price'>200万-500万(<?php echo $total_2000000_5000000;?>)</a>
                      <a href="javascript:void(0)" values="5000000d" attrval="500万以上" type='Price'>500万以上(<?php echo $total_5000000d;?>)</a></dd>
                    </dl>
     ...
     <!-- 项目列表 -->
            ...
            <!-- 项目列表内容 -->
            <ul class="pl-con">
            <?php if(is_array($rows)): foreach($rows as $key=>$rows): ?><li id="<?php echo $rows['p_id'];?>" ondblclick="ProListInfo(this)" onclick="test(this)">
                   ...
                   <div class="pl-con-right2">
                        ...
                        <p><span class="s03">3</span><span class="s02"></span><span class="s01"></span></p> 
                   </div>
          	...
          	if(!data['rows']){
				...
				$("#Camount").html(0);
          	    ...
          	    for(var i=0;i<rows.length;i++){
					...
					//7/28去掉回款
					//<p style="margin-bottom:20px;">回款：'+rows[i]['percent']+'&nbsp;'+rows[i]['Pamount']+'</p>
...
function ProListInfo(obj){
	...
	//存cookie
	document.cookie="detial_type=hk";
